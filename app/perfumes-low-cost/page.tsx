...
export const metadata: Metadata = {
  title: "Perfumes Low Cost | Blog de Perfumes Argentina",
  description: "Los mejores perfumes de bajo costo en Argentina. Calidad real y precios accesibles.",
};
      ...
      <main className="flex-1 pb-16">
        <div className="mx-auto max-w-5xl px-5 sm:px-8">
          <Breadcrumbs items={[
            ...
            { label: "Perfumes Low Cost" },
          ]} />

          <div className="mt-6 mb-8">
            <div className="text-3xl mb-3">💰</div>
            <h1 className="font-display text-4xl sm:text-5xl">Perfumes Low Cost</h1>
            <p className="mt-3 text-base text-[var(--color-ink)]/65 max-w-xl">
              Los mejores perfumes de bajo costo en Argentina. Calidad real y precios accesibles.
            </p>
          </div>
